...
import 'package:skin_vault/widgets/skin_card.dart';
class MyHomePage extends StatelessWidget {
    final String npm = '2306152430'; // NPM
    final String name = 'Malvin Scafi'; // Nama
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "Skin Vault" dengan teks putih dan tebal.
        title: const Text(
          'Skin Vault',
          style: TextStyle(
            color: Colors.white,
